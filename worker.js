  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/translate") {
      ...
      if (request.method === "POST") {
        ...
        source = url.searchParams.get("source") || url.searchParams.get("sl") || "auto";
        target = url.searchParams.get("target") || url.searchParams.get("tl") || "en";
      }
      ...
      try {
        ...
        return new Response(JSON.stringify({ translatedText, source, target }), {
          headers: { "Content-Type": "application/json", ...corsHeaders }
        });
      } catch (err) {
...
<head>
  ...
  <title>ZipLoot - Cloud Serverless Translation Gateway</title>
...
<body>
  <header>
    <div class="logo">⚡ ZIPLOOT CLOUD TRANSLATE</div>
  </header>
  <div class="container">
